...
export const t = (key: keyof AppTranslations, user?: User, guestCountry?: string, fallback?: string): string => {
  return translationService.t(key, user, guestCountry, fallback);
};
