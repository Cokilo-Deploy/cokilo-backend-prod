...
class EmailVerificationService {
    ...
    static getCodeExpiration() {
        const expiration = new Date();
        expiration.setMinutes(expiration.getMinutes() + 15);
        return expiration;
    }
    static async sendVerificationCode(email, firstName, code) {
        try {
    ...
    static isCodeValid(receivedCode, storedCode, expirationDate) {
...
EmailVerificationService.transporter = nodemailer.createTransport({
